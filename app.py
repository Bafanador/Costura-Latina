...
# Se cargan desde las variables de entorno (archivo .env)
...
if __name__ == '__main__':
    ...
    # Puedes cambiarlo a 3000 si lo prefieres, como en el ejemplo de Node.js
    app.run(debug=True, port=3000) # 'debug=True' para desarrollo (recarga el servidor en cambios)
